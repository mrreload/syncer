...
//    public static String fullHash;
    ...
    public static void SndFile(String szUUID, String szType, String szFile, String iCurrentFile, String iTotalFile, String szOrgFile, String fullHash) {
        FileInputStream fis = null;
        try {
            int percent = Hasher.getPercent(Integer.parseInt(iCurrentFile), Integer.parseInt(iTotalFile));
            sndLOG.info("Sending: " + new File(szOrgFile).getName() + " to " + szUUID + "Chunk# " + iCurrentFile + " Of# " + iTotalFile + " " + percent + "%");
...
//            dos.close();
    ...
    public static void SendList(String szUUID, String szType, String[] szList, String OrgFileName, String theHash) throws IOException, Exception {
        ...
        for (int i = 0; i < szList.length; i++) {
            ...
            putFileQ(szUUID, szType, szList[i], chunkNum[1], szLastChunk[1], OrgFileName, theHash);
        }
        //senderBusy = false;

    }
    
    public static void putFileQ(String DestUID, String szType, String szFile, String iCurrentFile, String iTotalFile, String szOrgFileName, String szFullHash) {
...
//        }
        ...
        if (ConnectionHandler.sockets.get(szQmsg[1]).isConnected()) {
            switch (szQmsg[2]) {
                case "FIL":
                    SndFile(szQmsg[1], szQmsg[2], szQmsg[3], szQmsg[4], szQmsg[5], szQmsg[6], szQmsg[7]);
                    break;
                case "XLST":
